...
applies_to:
  ...
  - homelab-action
sync_locations:
  - ~/.gemini/SUB_RULES/HOMELAB_foundational_rules.md
  - ~/.gemini/antigravity/global_workflows/HOMELAB_foundational_rules.md
  - ~/.config/opencode/command/HOMELAB_foundational_rules.md
sync_note: ABSOLUTE rules that govern ALL homelab operations. No exceptions.
---
...
> Every homelab related action MUST adhere to these rules.
